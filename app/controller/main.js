...
module.exports.researchPost = function(req, res) {
  var urlParams = {
    title: req.body.title,
  };
  res.render("post", {
    title: res.title,
    //img: 'https://lums.edu.pk/sites/default/files/research/_mg_0195_0.jpg',
    excerpt: res.content,
    date: res.date,
  });
}
...
module.exports.index2 = function(req, res) {
  res.render("index", { 
    ...
    researches: [
      {
        profileId: 2,
        title: "Problematizing Citizenship in a Postcolonial Nation-State: A Case Study of Pakistan",
        //img: 'https://lums.edu.pk/sites/default/files/research/_mg_0195_0.jpg',
